...
//     corps, et seul un marqueur DE PLUS les séparerait. La matrice PLEINE et sous-comptée que rend une
//     lecture interrompue — le même défaut sous une forme que le tableau vide ne trahit pas — n'est
//     plus un reste de ce témoin depuis le 2026-09-09 (`P11.6-e`) : le démon la MARQUE (`P10.7-f`,
//     `lire_les_alertes_par_technique` → `corps_de_matrice_attack`, tenu par le test
//     `un_compte_d_alertes_par_technique_non_etabli_cesse_d_etre_un_zero`), et ce sont les témoins 55
//     et 57 qui tiennent son rendu (`P11.21-i`, `P11.21-j`), pas celui-ci.
// ---------------------------------------------------------------------------------------------
{
