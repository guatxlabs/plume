...
mod fondement; // P11.14-h : SUR QUOI UNE ALERTE EST FONDÉE, écrit à la levée dans un vocabulaire fermé — l'alerte NOMME les contrôles manquants, la machine et depuis quand (les trois étaient déjà en base, aucune n'était rendue) ; et un catalogue VIDE se dit au lieu de rendre « 0 manquant »
