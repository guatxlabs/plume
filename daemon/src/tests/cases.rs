    ...
    fn alert_groups_query() {
        ...
        let (groups, total, _) = alert_groups_query_page(&conn, "rule", &FiltreAlertes::default(), 50, 0);
        ...
        let (gnew, _, _) = alert_groups_query_page(&conn, "rule", &FiltreAlertes { statut: Some("new".into()), ..Default::default() }, 50, 0);
        ...
        let (gh, ght, _) = alert_groups_query_page(&conn, "host", &FiltreAlertes::default(), 50, 0);
        ...
        let (gact, _, _) = alert_groups_query_page(&conn, "rule", &FiltreAlertes { statut: Some("new".into()), ..Default::default() }, 50, 0);
        ...
        let (gall7, _, _) = alert_groups_query_page(&conn, "rule", &FiltreAlertes::default(), 50, 0);
